...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    if(localStorage.getItem("userInfo")){
      ...
      this.srcimage="http://smarthospital.somee.com/api/"+this.nurse.imageName+"?t=" + new Date().getTime()
      ...
      data => {
        ...
        this.service.update("Nurse/update",nurse).subscribe(
         (res:any)=>{
          ...
          this.srcimage="http://smarthospital.somee.com/api/"+res.imageName+"?t=" + new Date().getTime()  
          }
        )
         });
